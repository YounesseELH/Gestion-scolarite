                    ...
                    <fo:table border="1px solid" margin-left="1.8cm" margin-top="-24cm">
                        ...
                        <fo:table-body>
                            ...
                            <fo:table-row >
                                ...
                                <fo:table-cell border-left="2px solid black" border-right="2px solid black">
                                    <fo:block>
                                        <fo:table margin-left="-1.9cm" margin-top="-4mm">
                                            <fo:table-body text-align="center">
                                                <fo:table-row line-height="8mm">
                                                    <fo:table-cell border-left="2px solid black" border-right="2px solid black">
                                                ...
                                                <fo:table-row line-height="8mm" background-color="#9c6bff">
                                                    <fo:table-cell  border="2px solid black" width="10.8cm" text-align="center">
                                                        <fo:block>
                                                            <xsl:value-of select="/e:emploi_du_temps/e:semaine[@num='4']/e:vendredi/e:seance[@num='3']/e:type"/> - 
                                                            <xsl:value-of select="/e:emploi_du_temps/e:semaine[@num='4']/e:vendredi/e:seance[@num='3']/@horaire"/>
                                                        </fo:block>
                                                    </fo:table-cell>
                                                </fo:table-row>
                                                <fo:table-row line-height="8mm">
                                                    <fo:table-cell border-top="2px solid black" border-left="2px solid black" border-right="2px solid black">
                                                        <fo:block font-weight="bold">
                                                            <xsl:value-of select="/e:emploi_du_temps/e:semaine[@num='4']/e:vendredi/e:seance[@num='3']/e:matiere"/>
                                                        </fo:block>
                                                    </fo:table-cell>
                                                </fo:table-row>
                                                <fo:table-row line-height="8mm">
                                                    <fo:table-cell border-left="2px solid black" border-right="2px solid black">
                                                        <fo:block>
                                                            <xsl:value-of select="/e:emploi_du_temps/e:semaine[@num='4']/e:vendredi/e:seance[@num='3']/e:professeur"/>
                                                        </fo:block>
                                                    </fo:table-cell>
                                                </fo:table-row>
                                                <fo:table-row line-height="8mm">
                                                    <fo:table-cell border-bottom="2px solid black" border-left="2px solid black" border-right="2px solid black">
                                                        <fo:block padding-bottom="2mm">
                                                            <xsl:value-of select="/e:emploi_du_temps/e:semaine[@num='4']/e:vendredi/e:seance[@num='3']/e:salle"/> 
                                                        </fo:block>
                                                    </fo:table-cell>
                                                </fo:table-row>
                                            </fo:table-body>
